...
//
// Channel: cpp-queues_stream.delay_policy
// Client ID: cpp-queues-stream-delay-policy-client
//
...
int main() {
    ...
    options.set_client_id("cpp-queues-stream-delay-policy-client");
    ...
    std::string channel = "cpp-queues_stream.delay_policy";
