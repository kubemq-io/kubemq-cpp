...
//
// Channel: cpp-queues_stream.dead_letter_policy
// Client ID: cpp-queues-stream-dead-letter-policy-client
//
...
int main() {
    ...
    options.set_client_id("cpp-queues-stream-dead-letter-policy-client");
    ...
    std::string channel = "cpp-queues_stream.dead_letter_policy";
    std::string dlq_channel = "cpp-queues_stream.dead_letter_policy.dlq";
